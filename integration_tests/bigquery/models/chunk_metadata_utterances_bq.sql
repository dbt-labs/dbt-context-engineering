...
{#- attach_metadata over the transcript pipeline on BigQuery: same macro, same call shape
    as chunk_metadata_bq, pointed at a structurally different source. customer/participants
...
{{ dbt_context_engineering.attach_metadata(
    chunks_relation=ref('chunk_utterances_bq'),
