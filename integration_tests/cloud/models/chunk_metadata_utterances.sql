...
{#- attach_metadata over the transcript pipeline: same macro, same call shape
    as chunk_metadata, pointed at a structurally different source. customer/participants
