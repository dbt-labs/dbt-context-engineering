{#-
  ...
  Usage:
    dbt run-operation teardown --project-dir integration_tests/databricks
    dbt run-operation teardown --project-dir integration_tests/databricks --args "{'dry_run':false}"
-#}
