...
{#- ce_attach_metadata over the transcript pipeline on Snowflake: same macro, same call shape
    as ce_chunk_metadata_sf, pointed at a structurally different source. customer/participants
