{#-
  ...
  hide, so it does not belong inside a dispatched macro. Composing it as a step after ce_chunk keeps
  ...
  opposite of ce_knowledge_base, which promotes citation_url to a first-class column on purpose,
